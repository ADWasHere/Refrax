...
[docs/LOGGING.md](docs/LOGGING.md) for the level convention. For how releases are versioned and
which lines get patches, see [docs/BRANCHING.md](docs/BRANCHING.md).
