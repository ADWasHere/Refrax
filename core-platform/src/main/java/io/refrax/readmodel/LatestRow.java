...
public record LatestRow(
    ...
    public static class Builder {
        ...
        public Builder exposedJson(JsonObject exposedJson) {
            this.exposedJson = exposedJson;
            return this;
        }
        public Builder observedAt(OffsetDateTime observedAt) {
